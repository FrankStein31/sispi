                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-body py-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7">
                                        <!-- Responsive dengan ukuran tombol yang lebih baik -->
                                        <div class="d-flex flex-wrap justify-content-lg-end">
                                            <!-- Tambah margin kanan dan bawah untuk spacing -->
                                            <button type="button" class="btn btn-primary mb-2 me-2 px-4"
                                                onclick="showSelectedData()">
                                                <i class="fas fa-eye mr-2"></i> Tampilkan Data
                                            </button>
                                            <button type="button" class="btn btn-info text-white mb-2 me-2 px-4"
                                                onclick="selectAll()">
                                                <i class="fas fa-check-square mr-2"></i> Pilih Semua
                                            </button>
                                            <button type="button" class="btn btn-warning text-white mb-2 me-2 px-4"
                                                onclick="deselectAll()">
